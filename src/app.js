...
const adminMarketersRoutes = require('./routes/adminMarketersRoutes');
...
const teacherInstituteRoutes = require('./routes/teacherInstituteRoutes');
const instituteAffiliationRoutes = require('./routes/instituteAffiliationRoutes');
const teacherStaffRoutes = require('./routes/teacherStaffRoutes');
const publicInstituteRoutes = require('./routes/publicInstituteRoutes');
const teacherReferenceRoutes = require('./routes/teacherReferenceRoutes');
...
app.use('/v1/admin/marketers', adminMarketersRoutes);
...
app.use('/v1/teacher/staff', teacherStaffRoutes);
app.use('/v1/institutes', publicInstituteRoutes);
app.use('/v1/teacher/references', teacherReferenceRoutes);

...
CREATE INDEX IF NOT EXISTS idx_institute_affiliations_teacher ON institute_affiliations(teacher_id);
CREATE INDEX IF NOT EXISTS idx_institute_affiliations_institute ON institute_affiliations(institute_id, status);

CREATE UNIQUE INDEX IF NOT EXISTS idx_institute_affiliations_one_main
